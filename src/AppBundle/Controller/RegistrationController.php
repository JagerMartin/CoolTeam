...
// OVERRIDE FOSUSERBUNDLE REGISTRATION CONTROLLER
...
class RegistrationController extends BaseController
{
    public function registerAction(Request $request)
    {
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                ...
                /*****************************************************
                 * MODIFICATION ICI => GESTION DE LA NEWSLETTER      *
                 *****************************************************/
    ...
    private function manageNewsletterSubscription(User $user)
    {
        ...
        if($user->getIsNewsletterSubscriber()){ // Inscription à la newsletter si case cochée
